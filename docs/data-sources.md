...
| [MEDSL U.S. President 1976–2024](https://doi.org/10.7910/DVN/42MVDX) | National two-party presidential shares (lean normalization); statewide two-party shares per cycle (seats–votes series) | MIT Election Data + Science Lab | CC0; Dataverse guestbook on download |
