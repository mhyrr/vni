defmodule VNIWeb.DistrictPresenter do
  ...
  defp profile_fields(%DistrictProfile{} = profile) do
    %{
      ...
      last_margin_votes: profile.last_margin_votes && number(profile.last_margin_votes),
      last_margin_votes_value: profile.last_margin_votes,
      unopposed: profile.last_margin_pct == 100.0,
      margin_source_url: profile.margin_source_url,
      commitment_goal: VNI.Pledges.goal(profile),
      commitment_goal_label: number(VNI.Pledges.goal(profile)),
      commitment_goal_basis: VNI.Pledges.goal_basis(profile),
      partisan_lean: lean_label(profile.partisan_lean),
      lean_value: profile.partisan_lean,
  ...
  defp profile_fields(_missing_or_not_loaded) do
    %{
      ...
      last_margin_votes: nil,
      last_margin_votes_value: nil,
      unopposed: false,
      margin_source_url: nil,
      commitment_goal: VNI.Pledges.baseline_goal(),
      commitment_goal_label: number(VNI.Pledges.baseline_goal()),
